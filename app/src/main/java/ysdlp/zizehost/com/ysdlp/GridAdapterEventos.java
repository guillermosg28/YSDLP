...
public class GridAdapterEventos extends BaseAdapter {

    private final Context mContext;
    private final Dato[] items;

    public GridAdapterEventos(Context c, Dato[] items) {
        mContext = c;
        this.items = items;
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.grid_eventos, viewGroup, false);
        }
